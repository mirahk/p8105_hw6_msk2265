...
```
    ...
    ## Warning: Removed 3375 rows containing non-finite values (`stat_density()`).
...
![](p8105_hw6_msk2265_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ##  2 female     35      57  3374   147      45 white    39.6 absent        12
    ##  3 female     35      53  3345   127      65 black    39.7 absent        14
    ...
    ##  7 female     34      51  3005   149      85 white    39.3 absent        14
    ##  8 female     34      54  3345   130      95 white    42.1 absent        10
    ##  9 female     33      49  3147   140      45 white    40.6 absent        12
    ## 10 female     34      49  3317   142      35 white    40.4 absent        12
    ## # ℹ 859 more rows
    ## # ℹ 10 more variables: mheight <dbl>, momage <dbl>, mrace <chr>, parity <dbl>,
    ## #   pnumlbw <dbl>, pnumsga <dbl>, ppbmi <dbl>, ppwt <dbl>, smoken <dbl>,
    ## #   wtgain <dbl>
...
![](p8105_hw6_msk2265_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
