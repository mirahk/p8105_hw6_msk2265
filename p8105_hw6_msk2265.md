...
```
    ...
    ## Warning: Removed 3353 rows containing non-finite values (`stat_density()`).
...
```
    ...
    ##  3 female     33      49  2551   120      75 black    38.1 absent        11
    ##  4 male       35      56  3232   147      55 white    42.1 absent        13
    ##  5 male       34      52  3203   134      25 white    41.1 absent        14
    ##  6 female     35      50  3175   140      85 black    40.6 absent        14
    ##  7 female     36      51  2977   135      45 white    41.7 absent        13
    ##  8 male       36      52  3629   152      45 white    39.6 absent        11
    ##  9 male       38      53  3799   167      75 white    39.9 absent        12
    ## 10 female     33      54  3062   134      65 white    40.4 absent        12
    ## # ℹ 859 more rows
    ## # ℹ 10 more variables: mheight <dbl>, momage <dbl>, mrace <chr>, parity <dbl>,
    ## #   pnumlbw <dbl>, pnumsga <dbl>, ppbmi <dbl>, ppwt <dbl>, smoken <dbl>,
    ## #   wtgain <dbl>
